...
class doanvien_thanhnienController extends Controller
{
    ...
    public function get_phuongxa(Request $request){
        ...
        // dd($phuong_xa_ns);
            ...
            ->where('KHOA_ID', $request->session()->get('id_khoa'))
            ->where('chidoan.ID', $request->session()->get('id_chidoan'))
    ...
    public function getdoanvien(Request $request){
        ...
        ->select('doanvien_thanhnien.*','chidoan.TEN_CD','tongiao.TEN_TG','dantoc.TEN_DT','v_qq_ns.*','khoa.TEN_KHOA')
        ->get();
    ...
    public function doankhoa_index_getchidoan(Request $request){
        $khoa = khoa::all();
        return view('backend.doanvien_thanhnien.doankhoa_index_getchidoan')
        ->with('k', $khoa);
    }

    public function doankhoa_getchidoan(Request $request){
        $khoa = khoa::find($request->khoa);
        ...
        return view('backend.doanvien_thanhnien.doankhoa_index_getdoanvien')
        ->with('k', $khoa)
    ...
    // public function doankhoa_index_getdoanvien(Request $request){
    //     $id_doankhoa = $request->session()->get('session_id_doankhoa');
    //     $chidoan = chidoan::where('DOANKHOA_ID', $id_doankhoa)->get();
    //     // dd($chidoan);
    //     return view('backend.doanvien_thanhnien.doankhoa_index_getdoanvien')
    //     ->with('i_dk', $id_doankhoa)
    //     ->with('cd',$chidoan);
    ...
    public function doankhoa_getdoanvien(Request $request)
    {
        $chidoan = chidoan::find($request->chidoan);
        // dd($chidoan);
        // $ten_chidoan = $request->session()->get('session_ten_chidoan');
        ...
        ->join('dantoc', 'dantoc.ID', '=', 'doanvien_thanhnien.DANTOC_ID')
        ->where('CHIDOAN_ID', '=', $chidoan->ID)
        ->select('doanvien_thanhnien.*','chidoan.TEN_CD', 'khoa.TEN_KHOA','tongiao.TEN_TG','dantoc.TEN_DT','v_qq_ns.*')
        ->get();

        $request->session()->put('id_chidoan',$chidoan->ID);
        $request->session()->put('tên_chidoan',$chidoan->TEN_CD);
        // dd($request->session()->put('tên_chidoan'));
        // dd($request->session()->get('id_chidoan'));
    ...
    {
        if($request->session()->has('id_chidoan')){
         $doanvien_thanhnien = DB::table('doanvien_thanhnien')
         ->join('v_qq_ns', 'v_qq_ns.ID', '=', 'doanvien_thanhnien.ID')
         ->join('chidoan', 'chidoan.ID', '=', 'doanvien_thanhnien.CHIDOAN_ID')
         ->join('khoa', 'khoa.ID', '=', 'chidoan.KHOA_ID')
         ->join('tongiao', 'tongiao.ID', '=', 'doanvien_thanhnien.TONGIAO_ID')
         ->join('dantoc', 'dantoc.ID', '=', 'doanvien_thanhnien.DANTOC_ID')
         ->where('CHIDOAN_ID',$request->session()->get('id_chidoan'))
         ->select('doanvien_thanhnien.*','chidoan.TEN_CD','tongiao.TEN_TG','dantoc.TEN_DT','v_qq_ns.*', 'khoa.TEN_KHOA')
         ->get(); 
         // dd($doanvien_thanhnien);
     }elseif($request->session()->get('session_vt') == 3){
         $doanvien_thanhnien = DB::table('doanvien_thanhnien')
         ->join('v_qq_ns', 'v_qq_ns.ID', '=', 'doanvien_thanhnien.ID')
         ->join('chidoan', 'chidoan.ID', '=', 'doanvien_thanhnien.CHIDOAN_ID')
         ->join('khoa', 'khoa.ID', '=', 'chidoan.KHOA_ID')
...
//             and quan_huyen.TINH_THANHPHO_ID = tinh_thanhpho.ID
    ...
    public function store(Request $request)
    {
        ...
        if(!$doanvien_thanhnien|| !$doanvien_thanhnien2|| !$doanvien_thanhnien3|| !$doanvien_thanhnien4|| !$doanvien_thanhnien5)
        {
            ...
            $doanvien_thanhnien->NGAYCHUYENSH_SV = $request->ngaychuyensh;
    ...
    public function update(Request $request, $id)
    {
        ...
        // ->first();
        // $doanvien_thanhnien2 = doanvien_thanhnien::where('MSSV', $request->tenmssv)
        // ->orwhere('EMAIL_SV', $request->tenemail)
        // ->orwhere('SDT_SV',$request->tensdt)
        // ->get();
        // $doanvien_thanhnien3 = doanvien_thanhnien:: where('MSSV', $request->tenmssv)
        // ->first();
        // $doanvien_thanhnien4 = doanvien_thanhnien::where ('EMAIL_SV',$request->tenemail)
    ...
    public function thongtinsinhvien(Request $request)
    {
        $doanvien = $request->session()->get('session_id_sv');
        $doanvien_thanhnien = DB::table('doanvien_thanhnien')
        ->join('v_qq_ns', 'v_qq_ns.ID', '=', 'doanvien_thanhnien.ID')
        ->join('chidoan', 'chidoan.ID', '=', 'doanvien_thanhnien.CHIDOAN_ID')
        ...
        ->join('dantoc', 'dantoc.ID', '=', 'doanvien_thanhnien.DANTOC_ID')
        ->join('khoa', 'khoa.ID', 'chidoan.KHOA_ID')
        ->where('doanvien_thanhnien.ID', $doanvien)
        ->select('doanvien_thanhnien.*','chidoan.TEN_CD','tongiao.TEN_TG','dantoc.TEN_DT','v_qq_ns.*','doankhoa.TEN_DK','chidoan.TEN_CD','khoa.TEN_KHOA')
        ->get();
        // dd($doanvien_thanhnien);
