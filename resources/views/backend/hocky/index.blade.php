...
<div class="box-body">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{ route('hocky.bulkDeleteHK') }}" method="POST" id="xoanhieuForm">
        {!! csrf_field() !!}
        ...
        <table class="table table-bordered table-striped dataTable" id="example1" role="grid" aria-describedby="example1_info">
          <thead>
            <tr role="row">
              ...
              <th style="text-align: center;">Tên năm học</th>
          ...
          <tbody>  
            ...
            <tr class="odd" role="row">
              <td><input type="checkbox" onClick="checkbox_is_checked()" name="id[]" value="{{$hocky->ID}}" class="check-all"></td>
              <td class="sorting_1">{{$stt++}}</td>
              <td>{{$hocky->TEN_HK}}</td>
              <td>{{$hocky->TEN_NH}}</td>
              <td>
                <div class="btn-group">
                  <a href="{{ route('hocky.edit',['hocky'=>$hocky->ID])}}">
