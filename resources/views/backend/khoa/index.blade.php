...
<h1>
  QUẢN LÝ KHÓA
  <small>                
    <a href="{{route('khoa.create')}}" class="btn btn-success">
...
<div class="box-body">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{ route('khoa.bulkDeleteKHOA') }}" method="POST" id="xoanhieuForm">
        {!! csrf_field() !!}
        ...
        <table class="table table-bordered table-striped dataTable" id="example1" role="grid" aria-describedby="example1_info">
          ...
          <tbody>  
            ...
            <tr class="odd" role="row">
              <td><input type="checkbox" onClick="checkbox_is_checked()" name="id[]" value="{{$khoa->ID}}" class="check-all"></td>
              <td class="sorting_1">{{$stt++}}</td>
              <td>{{$khoa->TEN_KHOA}}</td>
              <td>
                <div  class="btn-group">
                  <a href="{{ route('khoa.edit',['khoa'=>$khoa->ID])}}">
