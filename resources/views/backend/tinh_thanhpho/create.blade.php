...
<div class="box box-primary">
  <form role="form" method="POST" action="{{ route('tinh_thanhpho.store') }}" enctype="multipart/form-data">
    {{ csrf_field() }}
    <div class="box-body">

      <div class="form-group">
        <label for="tentinh_thanhpho">Tên tỉnh thành phố</label>
        <input class="form-control" id="tentinh_thanhpho" name="tentinh_thanhpho" placeholder="Nhập tên tỉnh thành phố" type="text"  required>
      </div>
