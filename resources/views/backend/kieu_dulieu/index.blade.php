...
<h1>
  ...
  <small>                
    <a href="{{route('kieu_dulieu.create')}}" class="btn btn-success">
...
<div class="box-body">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{ route('kieu_dulieu.bulkDeleteKDL') }}" method="POST" id="xoanhieuForm">
        {!! csrf_field() !!}
        ...
        <table class="table table-bordered table-striped dataTable" id="example1" role="grid" aria-describedby="example1_info">
          <thead>
            <tr role="row">
              ...
              <th style="text-align: center;">Tên kiểu dữ liệu</th>
          ...
          <tbody>  
            ...
            <tr class="odd" role="row">
              <td><input type="checkbox" onClick="checkbox_is_checked()" name="id[]" value="{{$kieu_dulieu->ID}}" class="check-all"></td>
              <td class="sorting_1">{{$stt++}}</td>
              <td>{{$kieu_dulieu->TEN_KIEU_DULIEU}}</td>
              <td>
                <div class="btn-group">
                  <a href="{{ route('kieu_dulieu.edit',['kieu_dulieu'=>$kieu_dulieu->ID])}}">
