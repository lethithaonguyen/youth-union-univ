...
<h1>
  BIỂU ĐỒ THỐNG KÊ SỐ LƯỢNG ĐOÀN VIÊN
</h1>
<ol class="breadcrumb">
  <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
  <li class="active">Thống kê</li>
  <li class="active">Thống kê số lượng đoàn viên</li>
</ol>
@endsection
...
<div class="box">
  ...
  <div class="box-footer" >
    <div class="col-md-12" >
      <h2 align="center" style="color: teal; font-weight: bold;" >Biểu Đồ Thống Kê Số lượng Đoàn Viên Của Khoa</h2>
        ...
        <table class="table table-bordered table-hover" id="example1"  >
          <thead >
            <tr role="row" >
              ...
              <th tabindex="0" class="sorting" aria-controls="example1" style="width: 262.33px;text-align: center;" aria-label="Browser: activate to sort column ascending" rowspan="1" colspan="1">Số lượng đoàn viên</th>
            </tr>
          </thead>
          <?php
          $stt=1;
