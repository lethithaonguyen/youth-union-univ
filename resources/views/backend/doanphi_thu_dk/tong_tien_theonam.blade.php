...
<h1>
	BIỂU ĐỒ THỐNG KÊ SỐ TIỀN ĐÃ ĐÓNG CỦA KHOA
</h1>
<ol class="breadcrumb">
...
<div class="box-footer" >
  <div class="col-md-12" >
    ...
    <h2 align="center" style="color: teal;" ><b>Biểu Đồ Thống Kê Số Tiền Đã Đóng Của Khoa</b></h2>
<br>
     <form method="get" action="{{route('tong_tien_loc_theonam')}}" >
...
<button  class="btn btn-success"><a href="{{ route('doanphi_thu_dk.index') }}" style="color: white;"> Trở về </a></button>
@endsection
