...
<h1>
	BIỂU ĐỒ THỐNG KÊ SỐ TIỀN ĐÃ ĐÓNG CỦA ĐOÀN KHOA {{-- {{Session::get('session_ten_chidoan_sv')}} --}}
</h1>
<ol class="breadcrumb">
...
<div class="box">
	...
	<div class="box-footer" >
		<div class="col-md-12" >
			...
			<h2 align="center" style="color: teal;" ><b>THỐNG KÊ ĐOÀN PHÍ ĐÃ ĐÓNG VÀ CHƯA ĐÓNG CỦA ĐOÀN KHOA THEO NĂM</b></h2>
			<br>
			<form method="get" action="{{route('bieudocotchong_theonam_dk')}}" >
	...
	<figure class="highcharts-figure">
		...
		<p class="highcharts-description">
			<h4 align="center">Biểu đồ thể hiện số tiền đoàn phí đã đóng và chưa đóng trong 1 năm của các Đoàn Khoa</h4>
		</p>
	</figure>
	<div class="box-body">
				...
				<table class="table table-bordered table-hover" id="example1"  >
					<thead >
						<tr role="row" >
							...
							<th style="text-align: center;">Tên đòan khoa</th>
							<th style="text-align: center;">Số lượng chi đoàn</th>
