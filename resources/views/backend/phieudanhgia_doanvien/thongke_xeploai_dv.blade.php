...
<h1>
	BIỂU ĐỒ THỐNG KÊ XẾP LOẠI ĐOÀN VIÊN CỦA CHI ĐOÀN {{-- {{Session::get('session_ten_chidoan_sv')}} --}}
</h1>
<ol class="breadcrumb">
	<li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
	<li class="active">Thống kê</li>
	<li class="active">Thống kê xếp loại đoàn viên của chi đoàn</li>
</ol>
@endsection
...
<div class="box">
	...
	<div class="box-footer" >
		<div class="col-md-12" >
			...
			<h2 align="center" style="color: teal;" ><b>Biểu Đồ Thống Kê Xếp Loại Đoàn Viên Của Chi Đoàn</b></h2>
			<br>
			<form method="get" action="{{route('thongke_xeploai_theonam_dv')}}" >
...
<button  class="btn btn-success"><a href="{{ route('index_duyet_pdg_dv') }}" style="color: white;"> Trở về </a></button>
@endsection
