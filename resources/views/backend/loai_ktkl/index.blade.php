...
DANH SÁCH LOẠI KHEN THƯỞNG KỶ LUẬT
...
<div class="box-body">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{ route('loai_ktkl.bulkDeleteLKTKL') }}" method="POST" id="xoanhieuForm">
        {!! csrf_field() !!}
        ...
        <table class="table table-bordered table-striped dataTable" id="example1" role="grid" aria-describedby="example1_info">
          ...
          <tbody>  
            ...
            <tr class="odd" role="row">
              <td><input type="checkbox" onClick="checkbox_is_checked()" name="id[]" value="{{$loai_ktkl->ID}}" class="check-all"></td>
              <td class="sorting_1">{{$stt++}}</td>
              <td>{{$loai_ktkl->TEN_LOAIKTKL}}</td>
              <td>
                <div class="btn-group">
                  <a href="{{ route('loai_ktkl.edit',['loai_ktkl'=>$loai_ktkl->ID])}}">
