...
<h1>
  BIỂU ĐỒ THỐNG KÊ TÔN GIÁO
</h1>
<ol class="breadcrumb">
  <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
  <li class="active">Thống kê</li>
  <li class="active">Thống kê tôn giáo</li>
</ol>
@endsection
...
<div class="box-footer" >
  <div class="col-md-12" >
    <h2 align="center"><b>Biểu Đồ Thống Kê Số lượng Sinh Viên Theo Tôn Giáo</b></h2>
        ...
        <table class="table table-bordered table-hover" id="example1"  >
          <thead >
            <tr role="row" >
              ...
              <th style="text-align: center;">Số lượng sinh viên</th>
            </tr>
          </thead>
          <?php
          $stt=1;
  ...
  new Chart(document.getElementById("pie-chart"), {
    ...
    data: {
      ...
      datasets: [
      {
        ...
        backgroundColor: ["#FF00FF", "#4B0082", " #CD853F", " #800000","#7B68EE","#FF6A6A", "#48D1CC", "#76EE00", "#EEEE00","#B0E0E6", "#191970",  " #708090", "#FFE4E1", "#FF1493","#3e95cd", "#8e5ea2"],
