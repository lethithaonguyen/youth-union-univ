...
<h1>
  QUẢN LÝ MẪU PHIẾU
  <small>                
    <a href="{{route('mauphieu.create')}}" class="btn btn-success">
...
<div class="box-body">
  ...
  <div class="row">
    <div class="col-sm-12">
      <form action="{{ route('mauphieu.bulkDeleteMP') }}" method="POST" id="xoanhieuForm">
        {!! csrf_field() !!}
        ...
        <table class="table table-bordered table-striped dataTable" id="example1" role="grid" aria-describedby="example1_info">
          ...
          <tbody>  
            ...
            <tr class="odd" role="row">
              <td><input type="checkbox" onClick="checkbox_is_checked()" name="id[]" value="{{$mauphieu->ID}}" class="check-all"></td>
              <td class="sorting_1">{{$stt++}}</td>
              <td>{{$mauphieu->TEN_MP}}</td>
              <td>
                <div class="btn-group">
                  <a href="{{ route('mauphieu.edit',['mauphieu'=>$mauphieu->ID])}}">
