...
<head>
  <meta charset="utf-8">
  <link rel="shortcut icon" type="image/png" href="{{asset('hinh_luanvan/logo-Doan.png')}}"/>
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <title>Đoàn vụ Đoàn trường</title>
...
<style type="text/css">
  ...
  th{
    text-align: center; !important;
    background-color:   lightblue/*#FFE4B5*/;
    /*color: white;*/
  }
    p{
    color: black;
...
<style type="text/css">
  ...
  marquee {
    ...
    background-image: url('hinh_luanvan/doantruong2.jpg'); 
    font-size: 25px;
    font-weight: 800;
    color: white;
  }
...
<body class="hold-transition skin-blue sidebar-mini">
  <marquee behavior="alternate">HỆ THỐNG QUẢN LÝ ĐOÀN VỤ ĐOÀN TRƯỜNG ĐẠI HỌC CẦN THƠ</marquee>
  <div class="wrapper">
