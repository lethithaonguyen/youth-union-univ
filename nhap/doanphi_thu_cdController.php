...
class doanphi_thu_cdController extends Controller
{
 ...
 public function tong_tien_theonam_cd (){
...
public function thongke_thuchi_cd (){
    $nam_dp = namhoc::orderBy('ID','asc')->first();
    $khoa_dp = khoa::orderBy('ID','asc')->first();
    $namhoc = namhoc::all();
    $khoa = khoa::all();
    ...
    //dd($results1); 
// dd($tongtien);
// SELECT chidoan.ID, hocky.NAMHOC_ID,chidoan.TEN_CD, khoa.TEN_KHOA, namhoc.TEN_NH, sum(phieuchi_chi_cd.SOTIEN_CHI_CD) as tongchi_chidoan
// FROM chidoan, phieuchi_chi_cd,pt_chidoan,namhoc,hocky, khoa
// WHERE phieuchi_chi_cd.CHIDOAN_ID = chidoan.ID
// AND khoa.ID = chidoan.KHOA_ID
// and phieuchi_chi_cd.PT_CHIDOAN_ID= pt_chidoan.ID
// and pt_chidoan.HOCKY_ID= hocky.ID
// and hocky.NAMHOC_ID= namhoc.ID
// GROUP BY chidoan.ID, namhoc.ID, khoa.ID
...
public function bieudocotchong_cd (){
    $nam_dp = namhoc::orderBy('ID','asc')->first();
    $khoa_dp = khoa::orderBy('ID','asc')->first();
    $namhoc = namhoc::all();
    $khoa = khoa::all();
